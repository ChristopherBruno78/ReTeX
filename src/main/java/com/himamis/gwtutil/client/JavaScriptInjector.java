...
public class JavaScriptInjector {
  ...
  /** @param scriptResource javascript file */
  ...
  /**
   * @param scriptResource javascript file
   * @param noDefine whether to protect against using requirejs (see APPS-3018)
   */
  ...
  /**
   * @param js to inject
   * @return wheter the js injected already, or not. This check is made during injection, but can be
   *     useful.
   */
