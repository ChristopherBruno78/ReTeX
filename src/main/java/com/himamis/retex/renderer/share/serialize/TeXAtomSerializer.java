...
public class TeXAtomSerializer {
  ...
  public String serialize(Atom root) {
    ...
    if (root instanceof EmptyAtom || root instanceof BreakMarkAtom || root instanceof PhantomAtom) {
      return "";
    }
    ...
    if (root instanceof AccentedAtom) {
      ...
      String content = serialize(root.getBase());
    ...
    FactoryProvider.debugS(
        "Unhandled atom:" + (root == null ? "null" : (root.getClass() + " " + root)));
