...
public class CharBox extends Box {
  ...
  static {
    FRC = new Graphics().createImage(1, 1).createGraphics2D().getFontRenderContext();
  }
  ...
  public Area getArea() {
    ...
    final double x = size / FactoryProvider.getInstance().getFontFactory().getFontScaleFactor();
    if (x != 1) {
      a.scale(x);
    }
    return a;
