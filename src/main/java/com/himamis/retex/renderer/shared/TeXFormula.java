...
import com.himamis.retex.renderer.shared.platform.graphics.Image;
 ...
 *
 * <p>These formula's can be built using the built-in primitive TeX parser (methods with String
 ...
 * possible.
 *
 * <p><b> Important: All the provided methods modify this TeXFormula object, but all the TeXFormula
...
public class TeXFormula {
  ...
  /**
   * Centers the current TeXformula vertically on the axis (defined by the parameter "axisheight" in
   * the resource "TeXFont.xml".
   *
  ...
  public class TeXIconBuilder {
    ...
    /**
     * Specify the width of the formula (may be exact or maximum width, see {@link
  ...
  public static Image createBufferedImage(
      String formula, int style, double size, Color fg, Color bg) throws ParseException {
