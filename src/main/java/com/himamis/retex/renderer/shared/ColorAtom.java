...
public class ColorAtom extends Atom implements Row {
  ...
  /**
   * Creates a new ColorAtom that sets the given colors for the given atom. Null for a color means:
   * no specific color set for this atom.
   *
  ...
  public Box createBox(TeXEnvironment env) {
    ...
    if (background != null) copy.setBackground(background);
    if (color != null) copy.setColor(color);
