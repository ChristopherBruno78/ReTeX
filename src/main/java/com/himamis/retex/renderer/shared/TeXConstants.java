...
public class TeXConstants {
  ...
  /**
   * Delimiter type constant for putting delimiters over and under formula's: arrow with single line
   ...
   *
   * <p>The large versions of big operators are used and limits are placed under and over these
   ...
   *
   * <p>The small versions of big operators are used and limits are attached to these operators as
   ...
   *
   * <p>The same as the text style, but symbols are rendered in a smaller size.
   */
   ...
   *
   * <p>The same as the script style, but symbols are rendered in a smaller size.
   */
