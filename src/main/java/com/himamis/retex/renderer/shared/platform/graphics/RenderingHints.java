 ...
 */
package com.himamis.retex.renderer.shared.platform.graphics;

public interface RenderingHints {

  int KEY_ANTIALIASING = 1;
  int VALUE_ANTIALIAS_ON = 1;

  int KEY_RENDERING = 2;
  int VALUE_RENDER_QUALITY = 2;

  int KEY_TEXT_ANTIALIASING = 3;
  int VALUE_TEXT_ANTIALIAS_ON = 3;

  int KEY_INTERPOLATION = 4;
  int VALUE_INTERPOLATION_BILINEAR = 4;
  int VALUE_INTERPOLATION_NEAREST_NEIGHBOR = 5;
  int VALUE_INTERPOLATION_BICUBIC = 6;
}
