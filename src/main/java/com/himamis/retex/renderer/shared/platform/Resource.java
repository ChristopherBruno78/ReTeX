...
import com.himamis.retex.renderer.shared.platform.resources.ResourceLoader;
...
public class Resource {
  ...
  public Resource() {
    resourceLoader =
        FactoryProvider.getInstance().createResourceLoaderFactory().createResourceLoader();
  }
