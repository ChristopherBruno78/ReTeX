...
import com.himamis.retex.renderer.shared.platform.Geom;
import com.himamis.retex.renderer.shared.platform.Graphics;
import com.himamis.retex.renderer.shared.platform.geom.Area;
import com.himamis.retex.renderer.shared.platform.graphics.BasicStroke;
import com.himamis.retex.renderer.shared.platform.graphics.Color;
import com.himamis.retex.renderer.shared.platform.graphics.Graphics2DInterface;
import com.himamis.retex.renderer.shared.platform.graphics.Stroke;
 ...
 *
 * <p>Subclasses must implement the abstract {@link #draw(Graphics2DInterface, double, double)}
 * method (that paints the box). <b> This implementation must start with calling the method {@link
 * #startDraw(Graphics2DInterface, double, double)} and end with calling the method {@link
 * #endDraw(Graphics2DInterface)} to set and restore the color's that must be used for painting the
 * box and to draw the background!</b> They must also implement the abstract {@link #getLastFont()}
...
public abstract class Box {
  ...
  /**
   * The foreground color of the whole box. Child boxes can override this color. If it's null and it
   * has a parent box, the foreground color of the parent will be used. If it has no parent, the
   * foreground color of the component on which it will be painted, will be used.
   */
