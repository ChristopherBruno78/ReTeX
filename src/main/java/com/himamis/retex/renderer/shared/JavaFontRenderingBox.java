...
public class JavaFontRenderingBox extends Box {
  ...
  private static final TextAttribute KERNING;
  private static final Integer KERNING_ON;
  private static final TextAttribute LIGATURES;
  private static final Integer LIGATURES_ON;
