...
import com.himamis.retex.renderer.shared.commands.*;
...
public class Commands {
  ...
  private static final Command dollardollar =
      new CommandDollars.Dollar(false, TeXConstants.STYLE_DISPLAY);
  ...
  private static Command getOneWayCommand(String s) {
    ...
    switch (s) {
      ...
      case "begin@math":
        return new CommandMathStyles.OpenBracket(TeXConstants.Opener.BEGIN_MATH);
      case "end@math":
      ...
      case "[":
        return new CommandMathStyles.OpenBracket(TeXConstants.Opener.B_LSQBRACKET);
      case "]":
        return new CommandMathStyles.CloseBracket(
      ...
      case "(":
        return new CommandMathStyles.OpenBracket(TeXConstants.Opener.B_LBRACKET);
      case ")":
        return new CommandMathStyles.CloseBracket(
  ...
  private static Command getOneWayCommandBlock1(String s) {
    switch (s) {
      ...
      case "begin@matrix":
        return new EnvArray.Begin(ArrayTypes.MATRIX, ArrayOptions.getEmpty());
      case "end@matrix":
        return new EnvArray.End(ArrayTypes.MATRIX);
      case "begin@smallmatrix":
        return new EnvArray.Begin(ArrayTypes.SMALLMATRIX, ArrayOptions.getEmpty());
      case "end@smallmatrix":
        return new EnvArray.End(ArrayTypes.SMALLMATRIX);
      case "begin@align":
        return new EnvArray.Begin(ArrayTypes.ALIGN, ArrayOptions.getEmpty());
      case "end@align":
        return new EnvArray.End(ArrayTypes.ALIGN);
      case "begin@aligned":
        return new EnvArray.Begin(ArrayTypes.ALIGNED, ArrayOptions.getEmpty());
      case "end@aligned":
        return new EnvArray.End(ArrayTypes.ALIGNED);
      case "begin@flalign":
        return new EnvArray.Begin(ArrayTypes.FLALIGN, ArrayOptions.getEmpty());
      case "end@flalign":
        return new EnvArray.End(ArrayTypes.FLALIGN);
      case "begin@alignat":
        return new EnvArray.Begin(ArrayTypes.ALIGNAT, ArrayOptions.getEmpty());
      case "end@alignat":
        return new EnvArray.End(ArrayTypes.ALIGNAT);
      case "begin@alignedat":
        return new EnvArray.Begin(ArrayTypes.ALIGNEDAT, ArrayOptions.getEmpty());
      case "end@alignedat":
      ...
      case "begin@pmatrix":
        return new EnvArray.Begin(ArrayTypes.PMATRIX, ArrayOptions.getEmpty());
      case "end@pmatrix":
        return new EnvArray.End(ArrayTypes.PMATRIX, "lbrack", "rbrack");
      case "begin@bmatrix":
        return new EnvArray.Begin(ArrayTypes.BMATRIX, ArrayOptions.getEmpty());
      case "end@bmatrix":
      ...
      case "begin@Vmatrix":
        return new EnvArray.Begin(ArrayTypes.VMATRIX, ArrayOptions.getEmpty());
      case "end@Vmatrix":
    ...
    switch (s) {
          ...
          public Atom newI(TeXParser tp) {
            ...
            final RowAtom ra =
                new RowAtom(
                    sp,
                    new RomanAtom(
                        TeXParser.getAtomForLatinStr("mod", true)
      ...
      case "hookrightarrow":
        return new Command0A() {
          ...
          public Atom newI(TeXParser tp) {
            ...
            // XXX was -0.169
            ra.add(Symbols.LHOOK, new SpaceAtom(Unit.EM, -0.43), Symbols.RIGHTARROW);
            ra.setShape(true);
      ...
      case "Longrightarrow":
        return new Command0A() {
          ...
          public Atom newI(TeXParser tp) {
            final RowAtom ra = new RowAtom(3);
            ra.add(Symbols.BIG_RELBAR, new SpaceAtom(Unit.EM, -0.177), Symbols.BIG_RIGHTARROW);
            ra.setShape(true);
            return new TypedAtom(TeXConstants.TYPE_RELATION, ra);
          }
        };
      case "Longleftarrow":
        return new Command0A() {
          ...
          public Atom newI(TeXParser tp) {
            final RowAtom ra = new RowAtom(3);
            ra.add(Symbols.BIG_LEFTARROW, new SpaceAtom(Unit.EM, -0.177), Symbols.BIG_RELBAR);
            ra.setShape(true);
            return new TypedAtom(TeXConstants.TYPE_RELATION, ra);
          }
        };
      ...
      case "longleftrightarrow":
        return new Command0A() {
          ...
          public Atom newI(TeXParser tp) {
            final RowAtom ra = new RowAtom(3);
            ra.add(Symbols.LEFTARROW, new SpaceAtom(Unit.EM, -0.180), Symbols.RIGHTARROW);
            ra.setShape(true);
            return new TypedAtom(TeXConstants.TYPE_RELATION, ra);
          }
        };
      case "Longleftrightarrow":
        return new Command0A() {
          ...
          public Atom newI(TeXParser tp) {
            final RowAtom ra = new RowAtom(3);
            ra.add(Symbols.BIG_LEFTARROW, new SpaceAtom(Unit.EM, -0.180), Symbols.BIG_RIGHTARROW);
            ra.setShape(true);
            return new TypedAtom(TeXConstants.TYPE_RELATION, ra);
          }
        };
      ...
      case "iint":
        return new Command0A() {
          ...
          public Atom newI(TeXParser tp) {
            ...
            final SpaceAtom six = new SpaceAtom(Unit.MU, -6., 0., 0.);
            final SpaceAtom nine = new SpaceAtom(Unit.MU, -9., 0., 0.);
      ...
      case "iiiint":
        return new Command0A() {
          ...
          public Atom newI(TeXParser tp) {
            ...
            final Atom choice = new MathchoiceAtom(nine, six, six, six);
            final RowAtom ra =
                new RowAtom(integral, choice, integral, choice, integral, choice, integral);
            ra.lookAtLastAtom = true;
            return ra.changeType(TeXConstants.TYPE_BIG_OPERATOR);
          }
        };
      case "idotsint":
        return new Command0A() {
          ...
          public Atom newI(TeXParser tp) {
            ...
            final SpaceAtom sa = new SpaceAtom(Unit.MU, -1., 0., 0.);
            final RowAtom cdots = new RowAtom(cdotp, cdotp, cdotp);
            final RowAtom ra =
                new RowAtom(integral, sa, cdots.changeType(TeXConstants.TYPE_INNER), sa, integral);
            ra.lookAtLastAtom = true;
            return ra.changeType(TeXConstants.TYPE_BIG_OPERATOR);
          }
        };
      ...
      case "Dstrok":
        return new Command0A() {
          @Override
          public Atom newI(TeXParser tp) {
            final RowAtom ra = new RowAtom(new SpaceAtom(Unit.EX, -0.1, 0., 0.), Symbols.BAR);
      ...
      case "dstrok":
        return new Command0A() {
          @Override
          public Atom newI(TeXParser tp) {
            final RowAtom ra = new RowAtom(new SpaceAtom(Unit.EX, 0.25, 0., 0.), Symbols.BAR);
            final VRowAtom vra = new VRowAtom(new LapedAtom(ra, 'r'));
      ...
      case "Hstrok":
        return new Command0A() {
          ...
          public Atom newI(TeXParser tp) {
            final RowAtom ra =
                new RowAtom(new SpaceAtom(Unit.EX, 0.28, 0., 0.), Symbols.TEXTENDASH);
            final VRowAtom vra = new VRowAtom(new LapedAtom(ra, 'r'));
            vra.setRaise(Unit.EX, 0.55);
      ...
      case "smallfrowneq":
        return new Command0A() {
          ...
          public Atom newI(TeXParser tp) {
            final Atom at =
                new UnderOverAtom(
                    Symbols.EQUALS, Symbols.SMALLFROWN, new TeXLength(Unit.MU, -2.), true, true);
      ...
      case "frowneq":
        return new Command0A() {
          ...
          public Atom newI(TeXParser tp) {
            final Atom at =
                new UnderOverAtom(Symbols.EQUALS, Symbols.FROWN, TeXLength.getZero(), true, true);
            return at.changeType(TeXConstants.TYPE_RELATION);
          }
        };
      ...
      case "geoprop":
        return new Command0A() {
          ...
          public Atom newI(TeXParser tp) {
            ...
            final RowAtom ddot = new RowAtom(nd, new SpaceAtom(Unit.MU, 4., 0., 0.), nd);
            final TeXLength l = new TeXLength(Unit.MU, -3.4);
            Atom at = new UnderOverAtom(Symbols.MINUS, ddot, l, false, ddot, l, false);
            return at.changeType(TeXConstants.TYPE_RELATION);
          }
        };
      case "ratio":
      ...
      case "dotminus":
        return new Command0A() {
          ...
          public Atom newI(TeXParser tp) {
            Atom at =
                new UnderOverAtom(
                    Symbols.MINUS, Symbols.NORMALDOT, new TeXLength(Unit.EX, -0.4), false, true);
          ...
          public Atom newI(TeXParser tp) {
            if (!tp.isArrayMode()) {
              throw new ParseException(
                  tp, "The macro \\cellcolor is only available in array mode !");
            }
      ...
      case "rowcolor":
        return new Command0AImpl() {
          ...
          public Atom newI(TeXParser tp) {
            if (!tp.isArrayMode()) {
              throw new ParseException(
                  tp, "The macro \\rowcolor is only available in array mode !");
            }
            final Color c = CommandDefinecolor.getColor(tp);
      ...
      case "jlmTextitbf":
        return new Command0AImpl() {
          ...
          public Atom newI(TeXParser tp) {
            final String arg = tp.getGroupAsArgument();
            return new JavaFontRenderingAtom(arg, Font.BOLD | Font.ITALIC);
          }
        };
      case "doteq":
        return new Command0A() {
          ...
          public Atom newI(TeXParser tp) {
            final Atom at =
                new UnderOverAtom(
                    Symbols.EQUALS, Symbols.LDOTP, new TeXLength(Unit.MU, 3.7), false, true);
            return at.changeType(TeXConstants.TYPE_RELATION);
          }
        };
      case "cong":
        return new Command0A() {
          ...
          public Atom newI(TeXParser tp) {
            final VRowAtom vra =
                new VRowAtom(Symbols.SIM, new SpaceAtom(Unit.MU, 0., 1.5, 0.), Symbols.EQUALS);
        ...
        return new Command0A() {
          ...
          public Atom newI(TeXParser tp) {
            return new PhantomAtom(
                Symbols.LBRACK.changeType(TeXConstants.TYPE_ORDINARY), false, true, true);
          }
        };
      ...
      case "questeq":
        return new Command0A() {
          ...
          public Atom newI(TeXParser tp) {
            final Atom at =
                new UnderOverAtom(
                    Symbols.EQUALS, Symbols.QUESTION, new TeXLength(Unit.MU, 2.5), true, true);
            return at.changeType(TeXConstants.TYPE_RELATION);
          }
        };
      case "eqdef":
        return new Command0A() {
          ...
          public Atom newI(TeXParser tp) {
            return new BuildrelAtom(
                Symbols.EQUALS, new RomanAtom(TeXParser.getAtomForLatinStr("def", true)));
          }
        };
      ...
      case "hdotsfor":
        return new Command0AImpl() {
          ...
          public Atom newI(TeXParser tp) {
            if (!tp.isArrayMode()) {
              throw new ParseException(
                  tp, "The macro \\hdotsfor is only available in array mode !");
            }
      ...
      case "joinrel":
        return new Command0A() {
          @Override
          public Atom newI(TeXParser tp) {
            return new SpaceAtom(Unit.MU, -3, 0, 0).changeType(TeXConstants.TYPE_RELATION);
          }
        };
      ...
      case "vrule":
        return new Command0AImpl() {
          ...
          public Atom newI(TeXParser tp) {
            ...
            return new HVruleAtom(lengths[0], lengths[1], lengths[2], false);
          }
        };
      case "hrule":
        return new Command0AImpl() {
          ...
          public Atom newI(TeXParser tp) {
            final TeXLength[] lengths = tp.getDimensions();
            return new HVruleAtom(lengths[0], lengths[1], lengths[2], true);
          }
        };
      case "textvisiblespace":
        return new Command0A() {
          ...
          public Atom newI(TeXParser tp) {
            tp.skipPureWhites();
            final Atom a = new HVruleAtom(null, new TeXLength(Unit.EX, 0.3), null, false);
            return new RowAtom(
                new SpaceAtom(Unit.EM, 0.06),
                a,
                new HVruleAtom(new TeXLength(Unit.EM, 0.3), null, null, true),
                a);
          }
        };
      case "hspace":
      ...
      case "degree":
        return new Command0AImpl() {
          @Override
          public Atom newI(TeXParser tp) {
            return SubSupCom.get(SubSupCom.getBase(tp), null, Symbols.CIRC);
          }
        };
      case "sphat":
        return new Command0AImpl() {
      ...
      case "spbreve":
        return new Command0AImpl() {
          ...
          public Atom newI(TeXParser tp) {
            ...
            return SubSupCom.get(SubSupCom.getBase(tp), null, ra);
          }
        };
      case "spcheck":
        return new Command0AImpl() {
      ...
      case "copyright":
        return new Command0A() {
          ...
          public Atom newI(TeXParser tp) {
            ...
            a =
                new RaiseAtom(
                    a, new TeXLength(Unit.EX, 0.2), TeXLength.getZero(), TeXLength.getZero());
      ...
      case "dotsi":
        return new Command0A() {
          ...
          public Atom newI(TeXParser tp) {
            ...
            return new RowAtom(
                new SpaceAtom(TeXConstants.Muskip.NEGTHIN), ra.changeType(TeXConstants.TYPE_INNER));
          }
        };
      case "relbar":
        return new Command0A() {
