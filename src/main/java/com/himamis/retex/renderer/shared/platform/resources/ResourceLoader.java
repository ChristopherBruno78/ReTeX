 ...
 */
package com.himamis.retex.renderer.shared.platform.resources;
...
public interface ResourceLoader {
  ...
  /**
   * Loads a resource from the specified path. For specific return types please refer to the
   * implementations of this interface.
   *
   * @param path the path to the resource
   * @return resource
   */
  Object loadResource(String path) throws ResourceParseException;
}
