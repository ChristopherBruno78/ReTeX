...
public interface OpentypeFontStatusListener {
  ...
  /**
   * Called when the font is successfully loaded. Returns a Font object and the family name of the
   * font.
   *
   * @param font Font object
   * @param familyName name of the font
   */
  void onFontLoaded(OpentypeFontWrapper font, String familyName);
   ...
   * @param error
   */
  void onFontError(Object error, String familyName);
}
