...
import com.himamis.retex.renderer.client.geom.Rectangle2DW;
import com.himamis.retex.renderer.client.graphics.FontRenderContextW;
...
import com.himamis.retex.renderer.shared.platform.font.TextLayout;
...
public class TextLayoutW implements TextLayout {
  ...
  private final FontRenderContextW fontRenderContext;

  public TextLayoutW(String string, Font font, FontRenderContext fontRenderContext) {
    this.string = string;
