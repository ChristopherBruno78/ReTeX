...
import com.himamis.retex.renderer.client.geom.AreaW;
import com.himamis.retex.renderer.client.geom.ShapeW;
...
/**
 * @author michael
 *     <p>Shared class between JLaTeXMath and GeoGebra so that the transform can be shared
 *     https://jira.geogebra.org/browse/TRAC-5353
 *     <p>Also originally: Added to allow ctx.fill("evenodd") (new winding rule from ggb50) ignored
 *     in IE9, IE10
 */
...
public class JLMContext2d extends CanvasRenderingContext2D {
  ...
  @JsOverlay
  public final CanvasPattern createPatternSVG(
      String path, String style, double width, double height, double angle, String fill) {
